...
def index(req, userID):
	...
	gender = set.execqry("select gender from personalinfo where userID = " + userID + ";", False)[0][0]
	age_bracket = set.execqry("select agebracket from progressrecord where userid = " + userID + ";", False)[0][0]
	health_bracket = set.execqry("select healthstatus from progressrecord where userid = " + userID + ";", False)[0][0]
