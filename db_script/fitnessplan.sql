...
insert into fitnessplan(gender, ageBracket, healthStatus, exercisePlan, dietPlan)
   ...
   ('male', 'youngAdult', 'underweight', 'exercise plan 1bx', 'diet plan 1bx'),
   ('male', 'youngAdult', 'normal', 'exercise plan 1by', 'diet plan 1bz'),
   ('male', 'youngAdult', 'overweight', 'exercise plan 1bz', 'diet plan 1bz'),
   ('female', 'youngAdult', 'underweight', 'exercise plan 2bx', 'diet plan 2bx'),
   ('female', 'youngAdult', 'normal', 'exercise plan 2by', 'diet plan 2by'),
   ('female', 'youngAdult', 'overweight', 'exercise plan 2bz', 'diet plan 2bz'),
